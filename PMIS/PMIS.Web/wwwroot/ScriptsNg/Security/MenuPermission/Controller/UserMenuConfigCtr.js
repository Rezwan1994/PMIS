ngApp.controller('ngGridCtrl', ['$scope', 'UserMenuConfigService', 'permissionProvider', 'notificationservice', 'gridregistrationservice', '$http', '$log', '$filter', '$timeout', '$interval', '$q', function ($scope, UserMenuConfigService, permissionProvider, notificationservice, gridregistrationservice, $http, $log, $filter, $timeout, $interval, $q) {
    ...
    $scope.gridOptionsList.columnDefs = [
        ...
        , {
            name: 'MENU_NAME', field: 'MENU_NAME', displayName: 'Menu', enableFiltering: true, width: '17%', cellTemplate:
        ...
        , {
            name: 'LIST_VIEW_CHECK', field: 'LIST_VIEW_CHECK', displayName: 'List', enableFiltering: false, width: '7%', cellTemplate:
        ...
        , {
            name: 'CONFIRM_PERMISSION_CHECK', field: 'CONFIRM_PERMISSION_CHECK', displayName: 'Confirm', enableFiltering: false, width: '7%', cellTemplate:
